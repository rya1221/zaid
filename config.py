...
que = {}
SUDO_USERS = list(map(int, getenv("SUDO_USERS", "22165592").split()))
API_ID = int(getenv("API_ID", "6435225"))
API_HASH = getenv("API_HASH", "aa2886eda514d8beaa98695cfe3060ff")
LOG_CHAT = int(getenv("LOG_CHAT", "687154450"))
